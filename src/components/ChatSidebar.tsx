                    ...
                    >
                      <div className="flex items-start gap-3 flex-1 w-full">
                        ...
                        <div className="flex flex-col items-start flex-1 space-y-1 w-full overflow-hidden">
                          <span className="text-sm font-medium text-foreground group-hover:text-blue-600 transition-colors duration-200 whitespace-normal break-words leading-5 w-full">
                            {error}
                          </span>
